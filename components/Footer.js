                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex justify-center flex-wrap md:text-left text-center -mb-10 -mx-4">
                        ...
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <Link href={'/tshirts'} className="text-gray-600 hover:text-gray-800 cursor-pointer ">Tshirts</Link>
                                </li>
                                <li>
                                    <Link href={'/hoodies'} className="text-gray-600 hover:text-gray-800 cursor-pointer ">Hoodies</Link>
                                </li>
                                <li>
                                    <Link href={'/mugs'} className="text-gray-600 hover:text-gray-800 cursor-pointer ">Mugs</Link>
                                </li>
                                <li>
                                    <Link href={'/stickers'} className="text-gray-600 hover:text-gray-800 cursor-pointer ">Stickers Link</Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
